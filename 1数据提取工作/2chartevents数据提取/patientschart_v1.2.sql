  ...
  WHERE exclusion_pf=0 AND exclusion_vent=0 AND exclusion_los=0 AND exclusion_first_stay=0 AND exclusion_chest=0 AND exclusion_age=0
    ...
    SELECT ie.subject_id,ie.hadm_id,ie.icustay_id
      ...
      CASE
        ...
        WHEN itemid IN (681, 682, 2400, 2408, 2534, 2420, 224685) AND valuenum>100 AND valuenum<2000 THEN valuenum--tv
        ...
        WHEN itemid IN (445, 448, 450, 224687) AND valuenum>0 AND valuenum<50 THEN valuenum--mv
